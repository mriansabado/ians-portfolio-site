...
const projects = [
  {
    title: 'Fontastic', description: 'Input text and have it appear on your screen in full size. Communicate non-verbally to your friends across the room!', stack: 'React Native | Tailwind CSS | Expo | Lottie files', link: '#', image: Fontastic
  },
  {
